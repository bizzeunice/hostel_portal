...
<div id="sidebar">
    <div class="sidebar-header d-flex">
        ...
        <span>
            ...
            <p class="h3">Superadmin Dashboard</p>
        </span>
    </div>
    ...
    <div class="sidebar-menu">
        ...
        <a href="viewhostel.php" class="menu-item">
            ...
            <div class="menu-text">Manage Hostels</div>
        </a>
        ...
        <a href="#" class="menu-item">
            ...
            <div class="menu-text">Maintenance Requests</div>
        </a>
        ...
        <a href="#" class="menu-item">
            ...
            <div class="menu-text">Approve/Reject Requests</div>
        </a>
        <a href="#" class="menu-item">
            <div class="menu-icon"><i class="fas fa-history"></i></div>
            <div class="menu-text">Allocation History</div>
        </a>
        ...
        <a href="#" class="menu-item">
            ...
            <div class="menu-text">Payment Reports</div>
        </a>
        <a href="#" class="menu-item">
            <div class="menu-icon"><i class="fas fa-cog"></i></div>
            <div class="menu-text">Payment Settings</div>
        </a>
    ...
    <div class="sidebar-footer">
        <div class="dropdown">
            <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle"
                ...
                <p class="admin-name">Super Admin</p>
            </a>
